...
QAS (Quality)        - Integration and performance testing
```
...
| User ID | Role | Authorization |
|---------|------|---------------|
| MDGUSER01 | Material Creator | USMD_MODIFY |
| MDGUSER02 | Material Creator | USMD_MODIFY |
| MDGAPPR01 | Approver | USMD_APPROVE |
| MDGAPPR02 | Approver | USMD_APPROVE |
| MDGADM01 | Administrator | USMD_ALL |
...
```abap
* Check if material exists across systems
