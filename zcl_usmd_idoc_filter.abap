...
*&---------------------------------------------------------------------*
  METHOD filter_accounting_data.
    ...
    " Valuation area typically equals plant code
...
*&---------------------------------------------------------------------*
  METHOD add_custom_segments.
    ...
    " Example: Add custom Z-segment with receiver-specific data
    " This is useful for passing custom information to receiving system
